                    ...
                    <form method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-5 mb-3">
                                <label class="form-label fw-bold text-secondary">Responsável / Instrutor</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-white border-end-0 text-primary"><i class="bi bi-person-badge"></i></span>
                                    <input type="text" name="responsavel" class="form-control border-start-0" placeholder="Nome do responsável">
                                </div>
                            </div>
                        </div>
