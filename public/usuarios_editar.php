        ...
        <div class="col-md-7 col-lg-6">
            ...
            <div class="mb-4 d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Gerencie o perfil e permissões de acesso ao sistema.</p>
                </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <form action="usuarios_atualizar.php" method="post">
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold small text-uppercase">Nível de Acesso</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light text-muted"><i class="bi bi-shield-shaded"></i></span>
            ...
            <div class="mt-4 card bg-light border-0 shadow-sm">
                <div class="card-body py-3 d-flex align-items-center small text-muted">
                    ...
                    <div>
                        A alteração de senhas não é realizada por este painel administrativo por motivos de privacidade. Os usuários gerenciam suas próprias chaves no menu "Minha Conta".
                    </div>
                </div>
            </div>
