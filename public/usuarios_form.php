            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <form action="usuarios_salvar.php" method="post">
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold small text-uppercase <?= $usuario ? 'text-primary' : 'text-success' ?>">
                                <?= $usuario ? 'Alterar Senha' : 'Definir Senha' ?>
                            </label>
                            <div class="input-group">
                                <span class="input-group-text bg-light text-muted"><i class="bi bi-key"></i></span>
                                <input type="password" name="senha" class="form-control" 
                                       placeholder="<?= $usuario ? 'Deixe em branco para não alterar' : 'Digite a senha inicial' ?>"
                                       <?= $usuario ? '' : 'required' ?>>
                            </div>
                        </div>
