    ...
    <div class="container py-4">
        ...
        <div class="mb-4 no-print d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="ficha_final_pdf.php?participante_id=<?= $participante_id ?>" target="_blank" class="btn btn-outline-danger">
                    <i class="bi bi-file-earmark-pdf-fill me-1"></i> Imprimir Ficha Final (PDF)
                </a>
            </div>
        </div>
