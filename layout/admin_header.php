...
<head>
    ...
    <style>
        ...
        .sidebar {
            ...
            /* Dark neutro */
            border-top: 5px solid var(--ser-orange);
            /* Detalhe com a cor da imagem */
        ...
        .sidebar .nav-link i {
            ...
            margin-right: 12px;
            color: var(--ser-blue);
            /* Ícones no azul da imagem */
        }

        .sidebar .nav-link:hover {
            background-color: rgba(255, 255, 255, 0.05);
            color: var(--ser-orange);
            /* Texto no laranja ao passar o mouse */
        }
        ...
        .sidebar .text-danger:hover {
            background-color: rgba(166, 28, 98, 0.1);
            /* Sutil toque de vinho no hover do sair */
    ...
    <div class="d-flex">
        ...
        <div class="sidebar text-white shadow">
            ...
            <ul class="nav flex-column">
                ...
                <?php
                $nivelLogado = isset($_SESSION['usuario_nivel']) ? strtolower(trim($_SESSION['usuario_nivel'])) : '';
                ...
                ?>
                    ...
                    <li class="nav-item">
                        <a href="/public/logs_lista.php" class="nav-link">
                ...
                <li class="nav-item mt-auto">
                    <a href="/public/alterar_senha.php" class="nav-link">
